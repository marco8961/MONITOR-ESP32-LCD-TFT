...
        // Forzar redibujado base inmediatamente
...
    digitalWrite(PIN_TFT_LED, LOW); // Apaga pantalla

    pantallaEncendida = false;

    apagarWiFi(); // Desactiva por completo el transmisor WiFi para eliminar el ruido
...
          Serial.print("Servidor inaccesible. Codigo: ");
